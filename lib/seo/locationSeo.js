...
export function getLocationMetaDescription(placeName, countrySuffix = '') {
  return `Remote printer help in ${placeName}${countrySuffix}. We troubleshoot HP jams, offline errors, drivers, and WiFi — call anytime for LaserJet, OfficeJet, DeskJet, and Envy.`;
}
