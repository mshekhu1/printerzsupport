...
export function getLocationMetaDescription(placeName, countrySuffix = '') {
  return `24/7 HP printer support in ${placeName}${countrySuffix}. Fix offline errors, paper jams, driver issues, WiFi problems, and error codes on LaserJet, OfficeJet, DeskJet, and Envy.`;
}
...
export function generateHpLocationContent({
  ...
  return `
    ...
    <p>Need 24/7 HP printer support in ${inPlace}? Our technicians help with LaserJet, OfficeJet, DeskJet, and Envy printers — offline errors, paper jams, driver failures, WiFi problems, and error codes.</p>
