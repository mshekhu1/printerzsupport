/**
 * Page metadata aligned with Google-indexed titles and descriptions.
 */
...
export const pageSeo = {
  ...
  blog: buildMetadata({
    ...
    keywords: 'printer blog, printer guides, printer troubleshooting tips, printer setup tutorials',
    path: '/blog',
  }),
  ...
  forum: buildMetadata({
    ...
    keywords: 'HP printer support forum, printer help forum, printer troubleshooting community',
    path: '/forum',
  }),
