...
/**
 * Trim keyword meta to a short, natural list (Google ignores meta keywords,
 * but long stuffed lists look spammy in page source).
 */
export function getBlogKeywords(post) {
  if (!post.keywords) return undefined;
