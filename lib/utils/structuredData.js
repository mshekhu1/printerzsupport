...
export const getLocalBusinessSchema = () => ({
  ...
  "@type": "LocalBusiness",
  "name": SITE_NAME,
  "description": "HP Printer Support with 24/7 Customer Service — jams, offline errors, drivers, WiFi, and error codes.",
...
export const getOrganizationSchema = () => ({
  ...
  "@type": "Organization",
  "name": SITE_NAME,
  "description": "HP Printer Support and Customer Support for home and business customers across the United States.",
  "url": "https://www.printerzsupport.com",
