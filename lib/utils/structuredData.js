...
export const getLocalBusinessSchema = () => ({
  ...
  "@type": "LocalBusiness",
  "name": SITE_NAME,
  "description": "24/7 HP printer customer service and technical support by phone — jams, offline errors, drivers, WiFi, and error codes.",
...
export const getOrganizationSchema = () => ({
  ...
  "@type": "Organization",
  "name": SITE_NAME,
  "description": "24/7 HP printer customer service and technical support for home and business customers across the United States.",
  "url": "https://www.printerzsupport.com",
