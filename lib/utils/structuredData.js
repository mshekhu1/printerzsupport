...
export const getLocalBusinessSchema = () => ({
  ...
  "@type": "LocalBusiness",
  "name": SITE_NAME,
  "description": "Authorised repair for HP devices, with 24/7 support from printer specialists for jams, offline errors, drivers, WiFi, and error codes.",
  ...
  "sameAs": [
    ...
    "https://www.mapquest.com/us/michigan/printer-support-791268588"
  ]
...
export const getServiceSchema = () => ({
  "@context": "https://schema.org",
  "@type": "Service",
  "serviceType": "Authorised HP printer repair",
  "provider": {
    "@type": "LocalBusiness",
    "name": SITE_NAME
  },
  ...
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
    "name": "HP Printer Repair Services",
    "itemListElement": [
      {
        "@type": "Offer",
        "itemOffered": {
...
export const getOrganizationSchema = () => ({
  ...
  "@type": "Organization",
  "name": SITE_NAME,
  "description": "Authorised HP repair for home and business customers, with support from printer specialists across the United States.",
  "url": "https://www.printerzsupport.com",
