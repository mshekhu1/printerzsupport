...
export const getLocalBusinessSchema = () => ({
  ...
  "description": "Expert remote help for HP LaserJet, OfficeJet, DeskJet, and Envy printers. Available 24/7 for setup, troubleshooting, and repair.",
...
export const getOrganizationSchema = () => ({
  ...
  "@type": "Organization",
  "name": "HP Printer Support",
  "description": "Remote HP printer support for home and business users across the United States.",
  "url": "https://www.printerzsupport.com",
