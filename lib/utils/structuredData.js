...
export const getLocalBusinessSchema = () => ({
  ...
  "@type": "LocalBusiness",
  "name": SITE_NAME,
  "description": "Independent third-party HP printer support for LaserJet, OfficeJet, DeskJet, and Envy. Available 24/7 for offline errors, jams, drivers, WiFi, and error codes.",
...
export const getServiceSchema = () => ({
  ...
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
    "name": "HP Printer Support Services",
    "itemListElement": [
      {
        "@type": "Offer",
        "itemOffered": {
...
export const getOrganizationSchema = () => ({
  ...
  "@type": "Organization",
  "name": SITE_NAME,
  "description": "Independent third-party HP printer support for home and business users across the United States.",
  "url": "https://www.printerzsupport.com",
