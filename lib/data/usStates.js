...
export const getStateMetaDescription = (stateName) => getLocationMetaDescription(stateName);

export const getStateKeywords = (stateName) => getLocationKeywords(stateName);
