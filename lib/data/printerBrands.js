...
export const printerBrands = [
  {
    ...
    slug: 'hp',
    description: 'Authorised HP repair for Easy Start, event 74899, DesignJet, offline, and WiFi faults, with printer support for LaserJet, OfficeJet, DeskJet, and Envy.',
...
function generateHpHubContent() {
  return `
    <h1>HP Printer Maintenance</h1>
    <p>Get authorised repair for HP LaserJet, OfficeJet, DeskJet, Envy, PageWide, and DesignJet devices. Our printer specialists provide remote support for the specific fault you have, from setup failures to hardware errors.</p>
    ...
    <ul>
      ...
      <li><a href="/blog/hp-printer-maintenance-in-progress">Maintenance in progress stuck</a> — finish initialization without interrupting the printer</li>
      <li><a href="/blog/hp-auto-crossover-printer">Ethernet auto crossover / no link light</a> — check the cable, port, and network connection</li>
      <li><a href="/blog/hp-pick-motor-stalled">Pick motor stalled</a> — inspect the tray, rollers, and paper path</li>
      <li><a href="/blog/hp-invalid-wpa-passphrase">Invalid WPA passphrase</a> — fix WiFi security and password errors</li>
      <li><a href="/blog/how-to-fix-printer-offline-issues-troubleshooting">Printer offline</a> — restore USB, WiFi, or Ethernet communication</li>
      <li><a href="/blog/hp-printer-not-printing-fix">HP printer not printing</a> — clear queues and diagnose connection or hardware faults</li>
      <li><a href="/blog/hp-printer-wifi-not-connecting">HP WiFi not connecting</a> — reconnect to the correct wireless network</li>
      <li><a href="/blog/hp-printer-paper-jam-fix">Paper jam</a> — remove stuck paper and prevent repeated jams</li>
      <li><a href="/blog/hp-print-spooler-error-fix">Print spooler error</a> — restart the service and clear blocked jobs</li>
      <li><a href="/blog/hp-printer-error-codes-guide">HP error codes</a> — identify common messages and their fixes</li>
      <li><a href="/blog/hp-cartridge-not-recognized-fix">Cartridge not recognized</a> — reseat, clean, and verify compatible ink</li>
      <li><a href="/blog/hp-printer-printing-blank-pages">Printing blank pages</a> — check ink flow, printheads, and driver settings</li>
    </ul>
    ...
    <h2>How authorised HP repair works</h2>
    <ol>
    ...
    <h2>Get repair help</h2>
    <p>${getGetStartedCallHtml({ slug: 'hp' })} — printer support for HP owners is available 24/7.</p>
  `;
}
...
export const generateBrandContent = (brand) => {
  ...
  return `
    <h2>${brand.name} Printer Maintenance</h2>
