...
export const generateBrandContent = (brand) => {
  return `
    ...
    <p>Welcome to HP Printer Support - your trusted partner for comprehensive ${brand.name} printer support services. Whether you own a ${brand.series.join(', ')} printer or any other ${brand.name} model, our expert technicians provide remote support to help you resolve any ${brand.name} printer issues quickly and efficiently.</p>
