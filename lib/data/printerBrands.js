...
export const printerBrands = [
  {
    ...
    slug: 'hp',
    description: 'HP Printer Support for LaserJet, OfficeJet, DeskJet, and Envy printers',
...
export const generateBrandContent = (brand) => {
  const intro =
    ...
    <p>Welcome to Printer Support - your trusted partner for comprehensive HP printer support services. Whether you own a LaserJet, OfficeJet, DeskJet, Envy, PageWide, DesignJet printer or any other HP model, our expert technicians provide remote support to help you resolve any HP printer issues quickly and efficiently.</p>`
      : `<h2>${brand.name} Printer Support</h2>
