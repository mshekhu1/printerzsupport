...
export const getProvinceMetaDescription = (provinceName) =>
  getLocationMetaDescription(provinceName, ', Canada');

export const getProvinceKeywords = (provinceName) =>
  getLocationKeywords(provinceName, ', Canada');
