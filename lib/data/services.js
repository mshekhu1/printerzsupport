...
export const printerServices = [
  ...
  },
  {
    ...
    description:
      'Fix HP printer error codes, spooler problems, driver conflicts, and connectivity issues. 24/7 HP printer support for all major HP models.',
  ...
  },
  {
    ...
    description:
      '24/7 HP printer help by phone to fix HP printer errors. Urgent support for offices, home users, and remote workers anytime.',
...
export function generateServiceContent(service) {
  ...
  return `
    ...
    <p>Do not let printer problems slow you down. Contact ${SITE_NAME} for expert ${service.title.toLowerCase()}—available 24/7:</p>
    <ul>
