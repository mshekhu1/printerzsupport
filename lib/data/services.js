...
export const printerServices = [
  ...
  },
  {
    ...
    description:
      'Fix HP printer errors remotely — paper jams, offline errors, print quality, and hardware faults on HP LaserJet, OfficeJet, DeskJet, and Envy.',
    metaTitle: 'Fix HP Printer Error — Repair Service',
    icon: '🔧',
    color: '#ef4444',
    features: [
  ...
  },
  {
    ...
    description:
      'Diagnose error codes, spooler problems, driver conflicts, and connectivity issues on HP and other major brands — by phone.',
    metaTitle: 'Fix HP Printer Error — Troubleshooting',
    icon: '🔍',
    color: '#f59e0b',
    features: [
  ...
  },
  {
    ...
    title: '24/7 HP Printer Help',
    shortTitle: '24/7 Support',
    description:
      'Urgent phone support when a printer goes down — for offices, home users, and remote workers, any time of day.',
    metaTitle: '24/7 HP Printer Help — Fix HP Printer Error',
    icon: '🕒',
    color: '#ec4899',
    features: [
...
export function generateServiceContent(service) {
  ...
  return `
    <h1>${service.title}</h1>
    <p>${service.description} As part of our authorised HP repair service, experienced printer technicians provide remote support for homes and businesses across the United States and Canada so you can print again without visiting a shop.</p>
    ...
    <p>From single home printers to small office fleets, we adapt to your setup. We cover customers across the <a href="/us">United States</a> and <a href="/canada">Canada</a>.</p>

    <h2>Get ${service.title} today</h2>
    <p>Stuck on a printer problem? Call ${SITE_NAME} — we&apos;re here around the clock:</p>
    <ul>
