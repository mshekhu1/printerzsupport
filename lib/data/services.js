...
export const printerServices = [
  ...
  },
  {
    ...
    description:
      'Fix HP printer error codes, spooler problems, driver conflicts, and connectivity issues. Independent HP printer support for all major HP models.',
  ...
  },
  {
    ...
    title: '24/7 HP Printer Support',
    shortTitle: '24/7 Support',
    description:
      '24/7 HP Printer Support helpline to fix HP printer errors by phone. Urgent help for offices, home users, and remote workers anytime.',
    metaTitle: '24/7 HP Printer Support — Fix HP Printer Error',
    icon: '🕒',
    color: '#ec4899',
    features: [
...
export function generateServiceContent(service) {
  ...
  return `
    ...
    <p>Do not let printer problems slow you down. Contact HP Printer Support for expert ${service.title.toLowerCase()}—available 24/7:</p>
    <ul>
