  ...
  return (
    <div className="container mt-5">
      <div className="jumbotron text-center">
        <h1 className="display-4">Welcome to Printer Support</h1>
        <p className="lead">Your one-stop solution for all printer-related issues.</p>
      </div>
      <div className="row">
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-text">We offer the best prices for our top-notch services.</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="col-md-6">
                <div className="card animate__animated animate__fadeInRight mb-3">
                  <div className="card-body">
                    ...
                    <p className="card-text mt-3">"I highly recommend Printer Support for their professional and affordable services." - Jane Smith</p>
                  </div>
                </div>
              </div>
              <div className="col-md-6">
